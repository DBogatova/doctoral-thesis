...
% Absolute page-position overlays, used by endmatter/cv.tex to restore the
% hyperlinks that \includepdf strips from the included CV pages.
\usepackage{eso-pic}
...
%     INTERACTION=nonstopmode pdflatex "\def\finaldraft{}\input{main}"
