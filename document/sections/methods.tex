...
\thispagestyle{myheadings}
	...
	\section{Data processing}\label{section:methods:processing}
		...
		For \acrshort{scape} recordings, every step from the raw stack to
		$\Delta F/F_0$ time series is carried out by the \mavca{} pipeline
		written for this dissertation and documented in
		\cref{section:methods:software:scape}. That section supersedes the
		generic outline below, which applies to any other modality used here.
	...
	% ------------------------------------------------------------------------
	% The software written for this dissertation is documented in its own
	% section. Pipeline-specific processing details live there; the generic
	% \section{Data processing} above should stay short and point here.
	\input{sections/software/pipeline-scape}
